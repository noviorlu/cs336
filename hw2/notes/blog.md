...
- **(a) 从时间线上能认出 forward / backward / optimizer 三个阶段吗，各是什么形状？** 能，看左下，靠**斜率**认：前向 32 级上坡（每层留 166 MiB，12.8 → 18.1）；反向继续爬到 25.5（每层 −166 +410）；optimizer 垂直冲到 ~28.6 OOM。前两段的形状和图 2.2-1 左的模型一致。
