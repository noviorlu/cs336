...
4. **bf16 快 2×、省 20%，归约留 fp32**（§2.3）：加速来自 bytes 减半 × Tensor core；显存只减矩阵乘的 activation，权重、梯度不变，还多一份 bf16 权重副本；bf16 累加 `+0.01` 到 4.0 就停，所以 LayerNorm / softmax / loss 留 fp32。
