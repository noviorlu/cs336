...
> **A** 谁写什么 · **B** 卡从哪来、钱怎么花 · **C** 现在就该定的事 ·
> **§0–§9** 逐题清单 · 末尾是**博客产出规划**和**建议执行顺序**
...
> 逐题的执行次序不在这里，看文末「建议执行顺序」那张阶段表。
> 当前卡在阶段 1 的第一项：**§0 环境配置**（归 Claude）。
...
- [ ] → 图/表 + 2-3 句
- ⚠️ 需要最多 6 张 GPU；本机只有 1 张 → **这是计划里的第一次正式上云**（Modal，见 §C）。
